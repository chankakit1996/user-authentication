<template>
    <div class="sign-in-form">
        ...
        <div class="social-buttons">
            ...
            <a href="#" title="Sign in via Apple">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
        ...
        <form @submit="login">
            ...
            <div class="form-group remember-forgot">
                ...
                <div class="forgot">
                    <router-link to="/reset-password" class="forgot-pass-link"
            ...
            <div class="create-aacount">
                ...
                <router-link
                    to="/register"
                    class="text-underline sign-up-form-btn"
                >
  ...
  components: { ErrorInputText },
    ...
    setup() {
        ...
        const errors = computed(() => {
            return getters['login/allErrors'];
        });
        const root = { root: true };
        const login = async (e: Event) => {
            e.preventDefault();
            await dispatch('login/set', { submitted: true }, root);
            if (!errors.value.status) {
                dispatch('login/login', undefined, { root: true });
            }
        };
        return {
            login,
