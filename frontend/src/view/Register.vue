<template>
    <div class="sign-up-form">
        ...
        <div class="social-buttons">
            <a href="#" title="Sign up via Google">
                <svg
            ...
            <a href="#" title="Sign up via Apple">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
        ...
        <form @submit="register">
            <div class="form-group">
                ...
                <input
                    ...
                    :class="{ error: errors.username.length > 0 }"
                    @input="
                        set('register/set', { username: $event.target.value })
                    "
                />
                <ErrorInputText :errors="errors.username" />
            </div>
            <div class="form-group">
                ...
                <input
                    ...
                    @input="set('register/set', { email: $event.target.value })"
                />
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    @input="
                        set('register/set', { password: $event.target.value })
                    "
                />
                <ErrorInputText :errors="errors.password" />
            </div>
            <div class="form-group">
            ...
            <div class="create-aacount">
                ...
                <router-link
                    to="/login"
                    class="text-underline sign-in-form-btn"
                >
                    Sign In</router-link
                >
            </div>
  ...
  components: { ErrorInputText },
    ...
    setup() {
        ...
        const errors = computed(() => {
            return getters['register/allErrors'];
        });
        ...
        const register = async (e: Event) => {
            e.preventDefault();
            await set('register/set', { submitted: true });
            if (!errors.value.status) {
                dispatch('register/register', undefined, { root: true });
            }
        };
        return {
            set,
